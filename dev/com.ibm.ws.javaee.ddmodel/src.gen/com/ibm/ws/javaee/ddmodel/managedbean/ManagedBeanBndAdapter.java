...
public class ManagedBeanBndAdapter implements ContainerAdapter<com.ibm.ws.javaee.dd.managedbean.ManagedBeanBnd> {
    ...
    final List<com.ibm.ws.javaee.dd.managedbean.ManagedBeanBnd> configurations = new CopyOnWriteArrayList<>();

    @Reference(cardinality = ReferenceCardinality.MULTIPLE, policy = ReferencePolicy.DYNAMIC, policyOption = ReferencePolicyOption.GREEDY)
    protected void setConfigurations(com.ibm.ws.javaee.dd.managedbean.ManagedBeanBnd configuration) {
        this.configurations.add(configuration);
    }

    protected void unsetConfigurations(com.ibm.ws.javaee.dd.managedbean.ManagedBeanBnd configuration) {
