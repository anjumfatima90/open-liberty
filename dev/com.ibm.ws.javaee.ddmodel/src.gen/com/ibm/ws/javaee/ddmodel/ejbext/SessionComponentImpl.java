...
public class SessionComponentImpl extends com.ibm.ws.javaee.ddmodel.ejbext.EnterpriseBeanType implements com.ibm.ws.javaee.dd.ejbext.Session {
    ...
    protected void setTime_out(com.ibm.ws.javaee.dd.ejbext.TimeOut time_out) {
        this.time_out = time_out;
    }

    protected void unsetTime_out(com.ibm.ws.javaee.dd.ejbext.TimeOut time_out) {
        if (time_out == this.time_out) {
            this.time_out = null;
        }
    }
    ...
    protected void setBean_cache(com.ibm.ws.javaee.dd.ejbext.BeanCache bean_cache) {
        this.bean_cache = bean_cache;
    }

    protected void unsetBean_cache(com.ibm.ws.javaee.dd.ejbext.BeanCache bean_cache) {
        if (bean_cache == this.bean_cache) {
            this.bean_cache = null;
        }
    }
    ...
    protected void setLocal_transaction(com.ibm.ws.javaee.dd.commonext.LocalTransaction local_transaction) {
        this.local_transaction = local_transaction;
    }

    protected void unsetLocal_transaction(com.ibm.ws.javaee.dd.commonext.LocalTransaction local_transaction) {
        if (local_transaction == this.local_transaction) {
            this.local_transaction = null;
        }
    }
    ...
    protected void setGlobal_transaction(com.ibm.ws.javaee.dd.commonext.GlobalTransaction global_transaction) {
        this.global_transaction = global_transaction;
    }

    protected void unsetGlobal_transaction(com.ibm.ws.javaee.dd.commonext.GlobalTransaction global_transaction) {
        if (global_transaction == this.global_transaction) {
            this.global_transaction = null;
        }
    }
    ...
    protected void setStart_at_app_start(com.ibm.ws.javaee.dd.ejbext.StartAtAppStart start_at_app_start) {
        this.start_at_app_start = start_at_app_start;
    }

    protected void unsetStart_at_app_start(com.ibm.ws.javaee.dd.ejbext.StartAtAppStart start_at_app_start) {
        if (start_at_app_start == this.start_at_app_start) {
            this.start_at_app_start = null;
        }
    }
