...
public class SecurityRoleComponentImpl implements com.ibm.ws.javaee.dd.appbnd.SecurityRole {
    ...
    protected void setRun_as(com.ibm.ws.javaee.dd.appbnd.RunAs run_as) {
        this.run_as = run_as;
    }

    protected void unsetRun_as(com.ibm.ws.javaee.dd.appbnd.RunAs run_as) {
        if (run_as == this.run_as) {
            this.run_as = null;
        }
    }
