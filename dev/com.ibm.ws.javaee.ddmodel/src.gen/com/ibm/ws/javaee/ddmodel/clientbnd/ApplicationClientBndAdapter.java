...
public class ApplicationClientBndAdapter implements ContainerAdapter<com.ibm.ws.javaee.dd.clientbnd.ApplicationClientBnd> {
    ...
    final List<com.ibm.ws.javaee.dd.clientbnd.ApplicationClientBnd> configurations = new CopyOnWriteArrayList<>();

    @Reference(cardinality = ReferenceCardinality.MULTIPLE, policy = ReferencePolicy.DYNAMIC, policyOption = ReferencePolicyOption.GREEDY)
    protected void setConfigurations(com.ibm.ws.javaee.dd.clientbnd.ApplicationClientBnd configuration) {
        this.configurations.add(configuration);
    }

    protected void unsetConfigurations(com.ibm.ws.javaee.dd.clientbnd.ApplicationClientBnd configuration) {
        this.configurations.remove(configuration);
    }

    @Override
    @FFDCIgnore(ParseException.class)
    public com.ibm.ws.javaee.dd.clientbnd.ApplicationClientBnd adapt(Container root, OverlayContainer rootOverlay, ArtifactContainer artifactContainer,
        ...
        if (ddEntry != null) {
            try {
                com.ibm.ws.javaee.dd.clientbnd.ApplicationClientBnd fromApp = new com.ibm.ws.javaee.ddmodel.clientbnd.ApplicationClientBndDDParser(containerToAdapt, ddEntry, xmi).parse();
                if (fromConfig == null) {
                    return fromApp;
                } else {
