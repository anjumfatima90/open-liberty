...
public class WebBndAdapter implements ContainerAdapter<com.ibm.ws.javaee.dd.webbnd.WebBnd> {
    ...
    final List<com.ibm.ws.javaee.dd.webbnd.WebBnd> configurations = new CopyOnWriteArrayList<>();

    @Reference(cardinality = ReferenceCardinality.MULTIPLE, policy = ReferencePolicy.DYNAMIC, policyOption = ReferencePolicyOption.GREEDY)
    protected void setConfigurations(com.ibm.ws.javaee.dd.webbnd.WebBnd configuration) {
        this.configurations.add(configuration);
    }

    protected void unsetConfigurations(com.ibm.ws.javaee.dd.webbnd.WebBnd configuration) {
        this.configurations.remove(configuration);
    }

    @Override
    @FFDCIgnore(ParseException.class)
    public com.ibm.ws.javaee.dd.webbnd.WebBnd adapt(Container root, OverlayContainer rootOverlay, ArtifactContainer artifactContainer,
        ...
        if (ddEntry != null) {
            try {
                com.ibm.ws.javaee.dd.webbnd.WebBnd fromApp = new com.ibm.ws.javaee.ddmodel.webbnd.WebBndDDParser(containerToAdapt, ddEntry, xmi).parse();
                if (fromConfig == null) {
                    return fromApp;
                } else {
