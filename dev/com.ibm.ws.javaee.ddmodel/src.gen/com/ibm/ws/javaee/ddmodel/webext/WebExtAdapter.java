...
public class WebExtAdapter implements ContainerAdapter<com.ibm.ws.javaee.dd.webext.WebExt> {
    ...
    final List<com.ibm.ws.javaee.dd.webext.WebExt> configurations = new CopyOnWriteArrayList<>();

    @Reference(cardinality = ReferenceCardinality.MULTIPLE, policy = ReferencePolicy.DYNAMIC, policyOption = ReferencePolicyOption.GREEDY)
    protected void setConfigurations(com.ibm.ws.javaee.dd.webext.WebExt configuration) {
        this.configurations.add(configuration);
    }

    protected void unsetConfigurations(com.ibm.ws.javaee.dd.webext.WebExt configuration) {
