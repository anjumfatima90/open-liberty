...
public class EJBJarExtAdapter implements ContainerAdapter<com.ibm.ws.javaee.dd.ejbext.EJBJarExt> {
    ...
    final List<com.ibm.ws.javaee.dd.ejbext.EJBJarExt> configurations = new CopyOnWriteArrayList<>();

    @Reference(cardinality = ReferenceCardinality.MULTIPLE, policy = ReferencePolicy.DYNAMIC, policyOption = ReferencePolicyOption.GREEDY)
    protected void setConfigurations(com.ibm.ws.javaee.dd.ejbext.EJBJarExt configuration) {
        this.configurations.add(configuration);
    }

    protected void unsetConfigurations(com.ibm.ws.javaee.dd.ejbext.EJBJarExt configuration) {
        this.configurations.remove(configuration);
    }

    @Override
    @FFDCIgnore(ParseException.class)
    public com.ibm.ws.javaee.dd.ejbext.EJBJarExt adapt(Container root, OverlayContainer rootOverlay, ArtifactContainer artifactContainer,
        ...
        if (ddEntry != null) {
            try {
                com.ibm.ws.javaee.dd.ejbext.EJBJarExt fromApp = new com.ibm.ws.javaee.ddmodel.ejbext.EJBJarExtDDParser(containerToAdapt, ddEntry, xmi).parse();
                if (fromConfig == null) {
                    return fromApp;
                } else {
    ...
    private com.ibm.ws.javaee.ddmodel.ejbext.EJBJarExtComponentImpl getConfigOverrides(OverlayContainer rootOverlay,
