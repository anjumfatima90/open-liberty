...
public class EJBJarBndAdapter implements ContainerAdapter<com.ibm.ws.javaee.dd.ejbbnd.EJBJarBnd> {
    ...
    final List<com.ibm.ws.javaee.dd.ejbbnd.EJBJarBnd> configurations = new CopyOnWriteArrayList<>();

    @Reference(cardinality = ReferenceCardinality.MULTIPLE, policy = ReferencePolicy.DYNAMIC, policyOption = ReferencePolicyOption.GREEDY)
    protected void setConfigurations(com.ibm.ws.javaee.dd.ejbbnd.EJBJarBnd configuration) {
        this.configurations.add(configuration);
    }

    protected void unsetConfigurations(com.ibm.ws.javaee.dd.ejbbnd.EJBJarBnd configuration) {
        this.configurations.remove(configuration);
    }

    @Override
    @FFDCIgnore(ParseException.class)
    public com.ibm.ws.javaee.dd.ejbbnd.EJBJarBnd adapt(Container root, OverlayContainer rootOverlay, ArtifactContainer artifactContainer,
        ...
        if (ddEntry != null) {
            try {
                com.ibm.ws.javaee.dd.ejbbnd.EJBJarBnd fromApp = new com.ibm.ws.javaee.ddmodel.ejbbnd.EJBJarBndDDParser(containerToAdapt, ddEntry, xmi).parse();
                if (fromConfig == null) {
                    return fromApp;
                } else {
    ...
    private com.ibm.ws.javaee.ddmodel.ejbbnd.EJBJarBndComponentImpl getConfigOverrides(OverlayContainer rootOverlay,
