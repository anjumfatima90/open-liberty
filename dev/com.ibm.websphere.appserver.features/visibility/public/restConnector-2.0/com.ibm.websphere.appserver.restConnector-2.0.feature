...
-features=com.ibm.websphere.appserver.restHandler-1.0,io.openliberty.restConnector2.0.internal.ee-6.0;ibm.tolerates:="9.0",com.ibm.websphere.appserver.servlet-3.0;ibm.tolerates:="3.1,4.0,5.0"
