...
-features=com.ibm.websphere.appserver.json-1.0,io.openliberty.oauth2.0.internal.ee-6.0;ibm.tolerates:="9.0",com.ibm.wsspi.appserver.webBundleSecurity-1.0,com.ibm.wsspi.appserver.webBundle-1.0,com.ibm.websphere.appserver.classloading-1.0,com.ibm.websphere.appserver.servlet-3.0;ibm.tolerates:="3.1,4.0,5.0",com.ibm.websphere.appserver.internal.slf4j-1.7.7,com.ibm.websphere.appserver.ldapRegistry-3.0
-bundles=com.ibm.ws.com.google.gson.2.2.4, com.ibm.ws.org.jose4j, io.openliberty.org.apache.commons.codec, com.ibm.ws.security.common.jsonwebkey, com.ibm.ws.org.json.simple.1.1.1
-jars=com.ibm.websphere.appserver.api.oauth; location:=dev/api/ibm/, io.openliberty.oauth; location:=dev/api/ibm/, com.ibm.websphere.appserver.spi.oauth; location:=dev/spi/ibm/
