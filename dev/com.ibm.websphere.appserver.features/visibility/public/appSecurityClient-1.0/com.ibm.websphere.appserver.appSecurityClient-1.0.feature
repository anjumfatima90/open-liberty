...
edition=base
-features=io.openliberty.servlet.api-3.0;apiJar=false;ibm.tolerates:="3.1,4.0,5.0",com.ibm.websphere.appserver.ssl-1.0,com.ibm.websphere.appserver.csiv2Client-1.0,io.openliberty.appSecurityClient1.0.internal.ee-6.0;ibm.tolerates:="9.0"
