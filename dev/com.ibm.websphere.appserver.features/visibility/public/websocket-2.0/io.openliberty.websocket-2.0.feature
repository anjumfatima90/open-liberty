...
edition=core
-features=io.openliberty.jakarta.websocket-2.0,com.ibm.websphere.appserver.servlet-5.0,com.ibm.websphere.appserver.eeCompatible-9.0
-bundles=com.ibm.ws.wsoc.jakarta, com.ibm.ws.wsoc.1.1.jakarta
