...
-bundles=io.openliberty.grpc.1.0.internal.client, io.openliberty.grpc.client.1.0.thirdparty; location:="dev/api/third-party/,lib/", io.openliberty.org.apache.commons.logging
kind=ga
edition=core
