...
-features=com.ibm.websphere.appserver.containerServices-1.0,io.openliberty.jcaSecurity.internal.ee-6.0;ibm.tolerates:="9.0",com.ibm.websphere.appserver.transaction-1.1;ibm.tolerates:="1.2,2.0"
