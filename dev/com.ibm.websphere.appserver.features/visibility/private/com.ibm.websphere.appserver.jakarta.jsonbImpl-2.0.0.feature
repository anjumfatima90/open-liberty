...
symbolicName=com.ibm.websphere.appserver.jakarta.jsonbImpl-2.0.0
singleton=true
visibility=private
...
-bundles=com.ibm.ws.org.eclipse.yasson.1.0, \
  com.ibm.websphere.jakarta.jsonb.2.0; location:="dev/api/spec/,lib/"; mavenCoordinates="jakarta.json.bind:jakarta.json.bind-api:2.0"
kind=ga
edition=core
