...
-bundles=com.ibm.ws.security.mp.jwt,com.ibm.websphere.org.eclipse.microprofile.jwt.1.0; location:="dev/api/stable/,lib/"; mavenCoordinates="org.eclipse.microprofile.jwt:microprofile-jwt-auth-api:1.0",com.ibm.ws.security.mp.jwt.cdi,io.openliberty.org.apache.commons.codec, io.openliberty.org.apache.commons.logging
kind=ga
edition=core
