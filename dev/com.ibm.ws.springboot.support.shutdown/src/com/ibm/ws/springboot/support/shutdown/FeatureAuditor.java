    ...
    public void postProcessEnvironment(ConfigurableEnvironment env, SpringApplication app) {
        ...
        if ( appHasSpring40 ) {
            ...
            if ( libertyHasSpring15 || libertyHasSpring20  || libertyHasSpring30) {
                ApplicationTr.error("error.spring4.required");
                ...
                ApplicationTr.error("error.spring4.requires.servlet6.application");
                ...
                ApplicationTr.error("error.spring4.requires.websocket2.application");
