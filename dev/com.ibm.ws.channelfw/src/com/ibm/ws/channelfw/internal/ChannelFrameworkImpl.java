...
public class ChannelFrameworkImpl implements ChannelFramework, FFDCSelfIntrospectable {
    ...
    private static StaticValue<ChannelFrameworkImpl> singleton = StaticValue.createStaticValue(new Callable<ChannelFrameworkImpl>() {
        @Override
        public ChannelFrameworkImpl call() {
            return new ChannelFrameworkImpl();
        }
    });
